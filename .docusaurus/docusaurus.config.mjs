...
export default {
  ...
  "organizationName": "mocktomata",
  "projectName": "mocktomata.github.io",
  "i18n": {
    "defaultLocale": "en",
    "locales": [
      "en"
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "D:\\code\\mocktomata\\website\\sidebars.js",
          "editUrl": "https://github.com/mocktomata/website/blob/main",
          "routeBasePath": "/"
        },
        "theme": {
          "customCss": "D:\\code\\mocktomata\\website\\src\\css\\custom.css"
        }
      }
    ]
  ],
  ...
  "themeConfig": {
    ...
    "footer": {
      "style": "dark",
      "copyright": "Copyright © 2022 Unison Ventures, LLC.",
      "links": []
    },
    "prism": {
      "theme": {
